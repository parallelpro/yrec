...
NAME = mixwind  (worktree /Applications/YREC-wt/mixwind, branch rs/mixwind)
Area report: audit/readability-sweep-2026-09-03/mixwind.md

Assigned files (paths relative to the worktree root):
- src/mixing/burn_mix_extrapolated.f90
- src/mixing/burn_settle_mix.f90
- src/mixing/compute_scale_height.f90
- src/mixing/find_convection_zones.f90
- src/mixing/homogenize_convection_zones.f90
- src/mixing/mix.f90
- src/mixing/overshoot_boundaries.f90
- src/mixing/rotmix.f90
- src/mixing/semiconvection.f90
- src/mixing/solve_composition.f90
- src/mixing/temperature_gradients.f90
- src/setup/locate_shell_boundaries.f90
- src/setup/map_user_inputs.f90
- src/setup/rescale_model.f90
- src/setup/rezone.f90
- src/setup/rotation_stability_setup.f90
- src/setup/setup_solar_calibration.f90
- src/setup/setup_star_calibration.f90
- src/setup/setups.f90
- src/util/compute_timestep.f90
- src/util/timestep_limit_hburn.f90
- src/util/timestep_limit_heburn.f90
- src/util/timestep_limit_hr.f90
- src/util/timestep_limit_omega.f90
- src/util/timestep_limit_structure.f90
- src/util/version.f90
- src/util/xrng4.f90
- src/util/zero.f90
- src/wind/kawaler_wind.f90
- src/wind/massloss.f90
- src/wind/matt_structure_factor.f90
- src/wind/matt_wind.f90
- src/wind/mdot.f90
- src/wind/wcz.f90
- src/wind/wind_spindown.f90
- src/wind/wind_spindown_matt.f90
