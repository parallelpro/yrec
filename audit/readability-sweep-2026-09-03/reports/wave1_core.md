...
NAME = core  (worktree /Applications/YREC-wt/core, branch rs/core)
Area report: audit/readability-sweep-2026-09-03/core.md

Assigned files (paths relative to the worktree root):
- src/core/atmosphere_derivs.f90
- src/core/check_solar_calibration.f90
- src/core/check_star_calibration.f90
- src/core/envelope_derivs.f90
- src/core/envint_kernel.f90
- src/core/envint_lib.f90
- src/core/evolve_step.f90
- src/core/henyey_coefficients.f90
- src/core/henyey_eliminate.f90
- src/core/henyey_iterate.f90
- src/core/henyey_solve.f90
- src/core/main.f90
- src/core/monte_carlo.f90
- src/core/neutrino_flux_table.f90
- src/core/observables_lib.f90
- src/core/point_scratch_lib.f90
- src/core/read_starting_model.f90
- src/core/rebuild_envelope.f90
- src/core/run_yrec.f90
- src/core/shell_physics.f90
- src/core/star_setup.f90
- src/core/stitched_model.f90
- src/core/stop_conditions.f90
- src/core/surfbc.f90
- src/core/turnover_timescale.f90
- src/core/yrec_capi.f90
- src/core/yrec_reset.f90
