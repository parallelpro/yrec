...
! common/luout/: only short_file_unit is declared here for layout
! consistency with liburn.f90; it is not actually used in this file.
...
! common/oldmod/: previous-timestep model snapshot; only old_radius is
