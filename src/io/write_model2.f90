...
!
! llp 4/16/03
subroutine write_model2(log_luminosity_lsun, envelope_fit_coeffs, mixing_length, &
...
! blanket `use const_lib`. Same treatment as io/read_yrec7.f90.
