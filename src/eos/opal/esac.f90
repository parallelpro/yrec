...
!
      ...
      opal_eos%eos_output(opal_eos%eos_index_inverse(i_opal_p)) = opal_eos%eos_output(opal_eos%eos_index_inverse(i_opal_p))* &
...
! stale E and cv slots by T6 and moles*R/mu on every call.
      if (opal_eos%eos_index_inverse(i_opal_e) <= deriv_order) &
           opal_eos%eos_output(opal_eos%eos_index_inverse(i_opal_e)) = opal_eos%eos_output(opal_eos%eos_index_inverse(i_opal_e))* &
...
! EOS(IRI(4))=EOS(IRI(4))/SQRT(R*T6) in the original).
      ...
      if (rad_flag.eq.1) then
         ...
         if (opal_eos%eos_index_inverse(i_opal_cv) <= deriv_order) &
              opal_eos%eos_output(opal_eos%eos_index_inverse(i_opal_cv)) = opal_eos%eos_output(opal_eos%eos_index_inverse(i_opal_cv))* &
