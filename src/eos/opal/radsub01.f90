...
!-----Calculate EOS without radiation correction
      total_pressure = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(1))
      total_energy = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(2))
      total_entropy = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(3))
      chi_rho = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(5))*opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(1))/ &
           total_pressure
...
!---- Calculate EOS with radiation calculation
      total_pressure = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(1)) + radiation_pressure
      total_energy = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(2)) + radiation_energy
      total_entropy = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(3)) + radiation_entropy
      chi_rho = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(5))*opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(1))/ &
           total_pressure
      chi_t6 = (opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(1))*opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(6)) &
...
!    x  /molenak
      opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(1)) = total_pressure
      opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(2)) = total_energy
      opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(3)) = total_entropy
      opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(4)) = molar_specific_heat
      opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(5)) = chi_rho
      opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(6)) = chi_t6
...
!       eq. 16.16 Landau&Lifshitz (SEE line labeled DIRECT)
      opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(7)) = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(7)) + &
           gamma1 - gamma1_norad
      opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(8)) = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(8)) + &
           gamma2_over_gamma2_minus1 - gamma2_over_gamma2_minus1_norad
      opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(9)) = opal_eos%eos_output_01(opal_eos%eos_index_inverse_01(9)) + &
